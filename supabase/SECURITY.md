...
**План перед анонсом:** до наплыва закинуть в очередь несколько портфолио вручную с оператора аккаунтов (обычный флоу `submit_portfolio`, за реальные монеты оператора — не бесплатный кредит), чтобы у первых волн новых пользователей в сегменте «Ждёт ревью» сразу было что ревьюить. Как только они заработают на первых ревью — начнут подавать свои, и очередь пойдёт органически.
