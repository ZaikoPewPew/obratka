...
| `sql/referrals.sql` | referral-код на профиль (лимит 2), seed ops-only, RPC validate/redeem |
...
| `referral_seed_codes` | только через RPC (публичные пачки; живые коды не в git) |
