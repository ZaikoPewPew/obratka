...
| `createHomeScreen` | `/home` + query | UI (feed/mine/rating топ-50 + SWR + intro + mine gate + Активные/Завершенные + free-slot + feedSeen/3/3 + «Топы в сети» + feedback + tabbar-dock + entrance cascade) |
