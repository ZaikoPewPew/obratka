...
| `avatarLetterTone.js` | стабильный tone letter-аватаров на карточках home: `getAvatarLetterToneIndex` + `applyAvatarLetterTone` (CSS var `--home-screen-avatar-letter-bg` на элементе) |
