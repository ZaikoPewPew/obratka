...
export const PLATFORM_BRAND_ICONS = Object.freeze([
  ...
  { suffix: "awwwards.com", slug: "awwwards", label: "Awwwards" },
  {
    ...
    faviconHost: "portfolio.adobe.com",
  ...
  { suffix: "wix.com", slug: "wix", label: "Wix" },
  {
    suffix: "elementor.cloud",
    slug: "elementor",
    faviconHost: "elementor.com",
    label: "Elementor",
  },
  { suffix: "elementor.com", slug: "elementor", label: "Elementor" },
  { suffix: "pixpa.com", faviconHost: "pixpa.com", label: "Pixpa" },
  { suffix: "cargo.site", faviconHost: "cargo.site", label: "Cargo" },
  {
    suffix: "cargocollective.com",
    faviconHost: "cargocollective.com",
    label: "Cargo",
  },
  {
    suffix: "my.canva.site",
    slug: "canva",
    faviconHost: "canva.com",
    label: "Canva",
  },
  { suffix: "canva.com", slug: "canva", label: "Canva" },
  {
    suffix: "carbonmade.com",
    faviconHost: "carbonmade.com",
    label: "Carbonmade",
  },
  { suffix: "format.com", faviconHost: "format.com", label: "Format" },
  {
    suffix: "journoportfolio.com",
    faviconHost: "journoportfolio.com",
    label: "Journo Portfolio",
  },
  { suffix: "contra.com", faviconHost: "contra.com", label: "Contra" },
  { suffix: "read.cv", faviconHost: "read.cv", label: "Read.cv" },
