...
| `home` | `/home` | Хаб: SWR feed/mine/rating + feedSeen/3/3 + «Топы в сети» + tabbar-dock + меню профиля |
...
Home: [`home-screen/README.md`](../components/home-screen/README.md) (`homeRoute` query, feed/mine/rating топ-50, SWR `homeListCache`, intro до claim, mine report gate, feedSeen/3/3, «Топы в сети», tabbar-dock + submit).
