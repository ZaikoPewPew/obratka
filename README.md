...
Статический лендинг вейтлиста: **Vite**, **vanilla JS**, анимация падающих карточек стартапов на **Matter.js**, локализация через `content/locales.json`, сохранение email в **Supabase** (таблица `subscribers` через PostgREST).
...
| `content/startups.json` | Число и данные для счётчика и падающих карточек |
