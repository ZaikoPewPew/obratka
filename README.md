...
| `/home` | Очередь / мои / рейтинг (топ-50); SWR, report gate, точки feedSeen + 3/3, intro до claim, tabbar-dock + submit; вид синхронизирован с query |
...
| [`src/components/home-screen/README.md`](src/components/home-screen/README.md) | Лента/мои/рейтинг, URL-query, SWR, review intro, mine report gate, feedSeen + 3/3, legendary aside, tabbar-dock + submit |
