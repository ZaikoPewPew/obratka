...
iframe / external: каталог [`content/embed-hosts.md`](content/embed-hosts.md) (`embedHosts` / `portfolioEmbed`; Readymag probe + frame-block → external UI).  
