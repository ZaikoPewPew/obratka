...
| `--shell-review-slider-*` | шкалы context/visual (readout / hint / track / canvas / thumb / stops + `--hot` / title motion) |
...
| `--tabs-panel-*` | сегмент feed/mine: track hug × **48**, центр колонки / tab hug × **40** / padding 4 / thumb; tab-dot 7px после подписи, gap 8px; RO без `instant` |
